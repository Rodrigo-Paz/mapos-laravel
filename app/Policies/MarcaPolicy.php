...
class MarcaPolicy
{
    ...
    {
        return $user->hasPermissionTo('marca_read');
    }
    ...
    {
        return $user->hasPermissionTo('marca_create');
    }
    ...
    {
        return $user->hasPermissionTo('marca_update');
    }
    ...
    {
        return $user->hasPermissionTo('marca_delete');
    }
